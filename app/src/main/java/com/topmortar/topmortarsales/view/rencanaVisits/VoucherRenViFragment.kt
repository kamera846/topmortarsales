...
import com.topmortar.topmortarsales.commons.RENVI_VOUCHER
...
import com.topmortar.topmortarsales.databinding.FragmentVoucherRenViBinding
 ...
 */
class VoucherRenViFragment : Fragment() {

    private var _binding: FragmentVoucherRenViBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVoucherRenViBinding.inflate(inflater, container, false)
        ...
        rvAdapter = RencanaVisitRVA(listItem, object: RencanaVisitRVA.ItemClickListener {
            override fun onItemClick(data: RencanaVisitModel?) {
                ...
                if (data != null) {
                    ...
                    intent.putExtra(RENVI_SOURCE, RENVI_VOUCHER)
                }
