...
class HistoryDeliveryRecyclerViewAdapter(
    private val listItem: ArrayList<DeliveryModel.History>,
    private val itemClickListener: ItemClickListener
) : RecyclerView.Adapter<HistoryDeliveryRecyclerViewAdapter.ChatViewHolder>() {
    ...
    inner class ChatViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: DeliveryModel.History) {
            var itemDescription = "Diselesaikan pada " + DateFormat.format(
                item.endDatetime,
                "yyyy-MM-dd HH:mm:ss",
                "dd MMM, HH:mm"
            )
